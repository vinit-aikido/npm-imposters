...
export const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-pink-950/20 to-background overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-4 space-y-12">
        ...
        <div className="text-center space-y-6 animate-fade-in">
          <div className="inline-block">
            <h1 className="text-7xl md:text-8xl font-bold text-foreground mb-4 tracking-tight">
              NPM
            </h1>
            <h1 className="text-7xl md:text-8xl font-bold bg-gradient-to-r from-pink-500 via-malware to-pink-600 bg-clip-text text-transparent mb-4">
              IMPOSTERS
            </h1>
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 text-center max-w-3xl">
          ...
          <div className="space-y-2">
            <div className="text-4xl font-bold text-cyan-500">096</div>
            <div className="text-sm text-muted-foreground flex items-center gap-2">
        ...
        <div className="space-y-4 animate-scale-in">
          <Button
            ...
            size="lg"
            className="text-2xl px-12 py-8 bg-gradient-to-r from-pink-600 to-pink-500 hover:from-pink-700 hover:to-pink-600 text-white font-bold shadow-2xl shadow-pink-500/50 hover:shadow-pink-500/70 transition-all hover:scale-105"
          >
